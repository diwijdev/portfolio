...
export const Hero = () => {
    ...
    return (
        <div id='home' className="container flex flex-wrap min-h-screen items-center justify-center">
            ...
            <div className="flex flex-col relative w-auto mx-auto px-3 sm:px-4 md:px-0">                
                ...
                >
                    <Motion.div className="relative flex flex-col lg:flex-row items-center justify-center md:justify-between w-full gap-x-10">
                        <Motion.h1
                            className="font-light text-[52px] tracking-[16px] bg-gradient-to-b from-[#ED1B68] via-[#ED1B68] to-[#9f0b1d] bg-clip-text text-transparent [-webkit-text-fill-color:transparent] inline-block sm:text-[64px] sm:tracking-[20px] md:text-[87px] md:tracking-[40px] lg:ml-7"
                        ...
                        <Motion.h1 className="font-light text-[52px] opacity-0 tracking-[16px] text-transparent absolute sm:text-[64px] sm:tracking-[20px] md:text-[87px] md:tracking-[40px] lg:relative" > 
                            DIWIJ
                        </Motion.h1>
                    </Motion.div>
                ...
                <Motion.div className="flex flex-wrap items-center justify-items-start relative md:items-start"
                    ...
                    animate="animate"
                >
                    <Motion.p className="mt-6 px-2 text-center md:absolute md:mt-0 md:translate-y-20 md:px-8.5 md:text-left md:text-xl md:font-light">
